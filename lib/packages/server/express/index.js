...
var server = function (sessionSecret, reqLimit) {
    if (sessionSecret === void 0) { sessionSecret = process.env.SESSION_SECRET; }
    if (reqLimit === void 0) { reqLimit = process.env.REQUEST_LIMIT; }
    var app = express_1.default();
    app.use(express_1.default.json({ limit: reqLimit || "100kb" }));
