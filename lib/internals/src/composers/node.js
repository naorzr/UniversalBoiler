...
var writeFile = function (rootDir) {
    ...
    return function (file) {
        return fs_extra_1.default.writeFile(path.join(rootDir, file.name), file.content);
    };
};
...
exports.createNodeApp = function (answers) { return __awaiter(void 0, void 0, void 0, function () {
    var serverType, appName, shouldUseTs, writeAppFile, packageJson, aggFiles, updatedPackageJson, filesWritten;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                packageJson = immutable_1.fromJS({ name: appName, version: "1.0.0" });
                return [4 /*yield*/, Promise.all([composer_1.default(answers), composer_2.default(answers)])];
            case 1:
                aggFiles = (_a.sent()).filter(function (i) { return typeof i !== "undefined"; });
                updatedPackageJson = aggFiles.reduce(function (aggPackageJson, i) { return aggPackageJson.mergeDeep(i.packageJson); }, packageJson);
